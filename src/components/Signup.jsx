  ...
  return (
    <div className='max-w-[700] mx-auto my-16 p-4'>
        <div>
            ...
            <p className='py-2'>Already have an account?<Link className='underline' to="/"> Sign in. </Link></p>
        </div>
        <form onSubmit={handleSubmit} >
            ...
            <button className="border border-blue-500 bg-blue-600 w-full p-4 my-2 text-white">Sign up</button>
        </form>
    </div>
  )
}
