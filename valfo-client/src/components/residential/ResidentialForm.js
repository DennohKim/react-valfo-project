         ...
         <form onSubmit={handleSubmit} className="flex flex-col bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="flex gap-x-8">
                  <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={formData.location} onChange={handleChange} name="location" type="number" placeholder="Location"/>
                  </div>
                </div>
